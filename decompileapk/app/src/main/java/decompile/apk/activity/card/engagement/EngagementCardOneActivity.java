...
public class EngagementCardOneActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((Button) findViewById(R.id.cancelButton)).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                EngagementCardOneActivity.this.finish();
            }
        });
        button.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                String str = "engagement_card_one";
                EngagementCardOneActivity.this.createPdf(str, ((EditText) EngagementCardOneActivity.this.findViewById(R.id.editText01)).getText().toString(), ((EditText) EngagementCardOneActivity.this.findViewById(R.id.editText02)).getText().toString(), ((EditText) EngagementCardOneActivity.this.findViewById(R.id.editText03)).getText().toString(), ((EditText) EngagementCardOneActivity.this.findViewById(R.id.editText04)).getText().toString(), ((EditText) EngagementCardOneActivity.this.findViewById(R.id.editText05)).getText().toString(), ((EditText) EngagementCardOneActivity.this.findViewById(R.id.editText06)).getText().toString(), ((EditText) EngagementCardOneActivity.this.findViewById(R.id.editText07)).getText().toString(), ((EditText) EngagementCardOneActivity.this.findViewById(R.id.editText08)).getText().toString(), ((EditText) EngagementCardOneActivity.this.findViewById(R.id.editText09)).getText().toString(), ((EditText) EngagementCardOneActivity.this.findViewById(R.id.editText10)).getText().toString(), ((EditText) EngagementCardOneActivity.this.findViewById(R.id.editText11)).getText().toString(), ((EditText) EngagementCardOneActivity.this.findViewById(R.id.editText12)).getText().toString(), ((EditText) EngagementCardOneActivity.this.findViewById(R.id.editText13)).getText().toString());
            }
        });
    }

    /* JADX WARNING: Failed to process nested try/catch */
    /* JADX WARNING: Missing block: B:34:0x03c9, code skipped:
            r0 = th;
     */
    /* JADX WARNING: Missing block: B:41:0x03e7, code skipped:
            r0 = move-exception;
     */
    /* JADX WARNING: Missing block: B:42:0x03e8, code skipped:
            r3 = r5;
            r2 = r0;
     */
        ...
        try {
            ...
            if (str16.equals(str22)) {
                ...
                try {
                    ...
                    BaseColor baseColor = new BaseColor(255, (int) CipherSuite.TLS_DH_anon_WITH_SEED_CBC_SHA, 77);
                    BaseColor baseColor2 = new BaseColor((int) CipherSuite.TLS_DH_RSA_WITH_CAMELLIA_256_CBC_SHA, 111, 91);
                    baseColor2 = new BaseColor(255, 231, 200);
                    try {
                        BaseColor baseColor3 = new BaseColor(255, (int) CipherSuite.TLS_DHE_DSS_WITH_AES_128_GCM_SHA256, 38);
                        ...
                        file = externalFilesDir;
                        Font font2 = new Font(createFont2, 30.0f, 1, baseColor3);
