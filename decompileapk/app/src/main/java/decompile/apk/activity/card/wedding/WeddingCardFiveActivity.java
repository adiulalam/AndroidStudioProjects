...
public class WeddingCardFiveActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((Button) findViewById(R.id.cancelButton)).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                WeddingCardFiveActivity.this.finish();
            }
        });
        button.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                String str = "card_five";
                WeddingCardFiveActivity.this.createPdf(str, ((EditText) WeddingCardFiveActivity.this.findViewById(R.id.editText01)).getText().toString(), ((EditText) WeddingCardFiveActivity.this.findViewById(R.id.editText02)).getText().toString(), ((EditText) WeddingCardFiveActivity.this.findViewById(R.id.editText03)).getText().toString(), ((EditText) WeddingCardFiveActivity.this.findViewById(R.id.editText04)).getText().toString(), ((EditText) WeddingCardFiveActivity.this.findViewById(R.id.editText05)).getText().toString(), ((EditText) WeddingCardFiveActivity.this.findViewById(R.id.editText06)).getText().toString(), ((EditText) WeddingCardFiveActivity.this.findViewById(R.id.editText07)).getText().toString(), ((EditText) WeddingCardFiveActivity.this.findViewById(R.id.editText08)).getText().toString(), ((EditText) WeddingCardFiveActivity.this.findViewById(R.id.editText09)).getText().toString(), ((EditText) WeddingCardFiveActivity.this.findViewById(R.id.editText10)).getText().toString(), ((EditText) WeddingCardFiveActivity.this.findViewById(R.id.editText11)).getText().toString());
            }
        });
    }

    /* JADX WARNING: Failed to process nested try/catch */
    /* JADX WARNING: Missing block: B:34:0x0372, code skipped:
            r0 = th;
     */
    /* JADX WARNING: Missing block: B:41:0x0390, code skipped:
            r0 = move-exception;
     */
    /* JADX WARNING: Missing block: B:42:0x0391, code skipped:
            r3 = r5;
            r2 = r0;
     */
        ...
        try {
            ...
            if (str14.equals(str20)) {
                ...
                try {
                    ...
                    BaseColor baseColor = new BaseColor(246, 224, 198);
                    BaseColor baseColor2 = new BaseColor(246, 224, 198);
                    BaseFont createFont = BaseFont.createFont("assets/fonts/bentham.otf", str19, true);
                    BaseFont createFont2 = BaseFont.createFont("assets/fonts/salma.otf", str19, true);
                    try {
