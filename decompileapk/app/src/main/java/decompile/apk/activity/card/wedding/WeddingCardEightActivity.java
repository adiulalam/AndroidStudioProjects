...
public class WeddingCardEightActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((Button) findViewById(R.id.cancelButton)).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                WeddingCardEightActivity.this.finish();
            }
        });
        button.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                String str = "card_eight";
                WeddingCardEightActivity.this.createPdf(str, ((EditText) WeddingCardEightActivity.this.findViewById(R.id.editText01)).getText().toString(), ((EditText) WeddingCardEightActivity.this.findViewById(R.id.editText02)).getText().toString(), ((EditText) WeddingCardEightActivity.this.findViewById(R.id.editText03)).getText().toString(), ((EditText) WeddingCardEightActivity.this.findViewById(R.id.editText04)).getText().toString(), ((EditText) WeddingCardEightActivity.this.findViewById(R.id.editText05)).getText().toString(), ((EditText) WeddingCardEightActivity.this.findViewById(R.id.editText06)).getText().toString(), ((EditText) WeddingCardEightActivity.this.findViewById(R.id.editText07)).getText().toString(), ((EditText) WeddingCardEightActivity.this.findViewById(R.id.editText08)).getText().toString(), ((EditText) WeddingCardEightActivity.this.findViewById(R.id.editText09)).getText().toString(), ((EditText) WeddingCardEightActivity.this.findViewById(R.id.editText10)).getText().toString(), ((EditText) WeddingCardEightActivity.this.findViewById(R.id.editText11)).getText().toString());
            }
        });
    }
