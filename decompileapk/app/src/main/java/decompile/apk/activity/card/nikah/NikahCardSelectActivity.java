...
import Adapter.NikahCardCategoryRecycleAdapter;
...
public class NikahCardSelectActivity extends AppCompatActivity {
    ...
    private Integer[] image = new Integer[]{Integer.valueOf(R.drawable.nikah_card_one_preview), Integer.valueOf(R.drawable.nikah_card_two_preview), Integer.valueOf(R.drawable.nikah_card_three_preview), Integer.valueOf(R.drawable.nikah_card_four_preview), Integer.valueOf(R.drawable.nikah_card_five_preview)};
    ...
    private NikahCardCategoryRecycleAdapter nikahCardCategoryRecycleAdapter;
    ...
    public String state;
    private String[] title = new String[]{"Card One", "Card Two", "Card Three", "Card Four", "Card Five"};
    public String tob;
    public String total_brothers;
    public String total_sisters;

    public NikahCardSelectActivity() {
        String str = "";
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_nikah_card_select);
        requestPermission();
        ...
        while (true) {
            ...
            if (i < numArr.length) {
                ...
                NikahCardCategoryRecycleAdapter nikahCardCategoryRecycleAdapter = new NikahCardCategoryRecycleAdapter(getApplicationContext(), this.cardCategoryModelClass);
                this.nikahCardCategoryRecycleAdapter = nikahCardCategoryRecycleAdapter;
                this.recyclerView.setAdapter(nikahCardCategoryRecycleAdapter);
                return;
            }
        }
    }
