...
public class ReceptionCardTwoActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((Button) findViewById(R.id.cancelButton)).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ReceptionCardTwoActivity.this.finish();
            }
        });
        button.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                String str = "reception_card_two";
                ReceptionCardTwoActivity.this.createPdf(str, ((EditText) ReceptionCardTwoActivity.this.findViewById(R.id.editText01)).getText().toString(), ((EditText) ReceptionCardTwoActivity.this.findViewById(R.id.editText02)).getText().toString(), ((EditText) ReceptionCardTwoActivity.this.findViewById(R.id.editText03)).getText().toString(), ((EditText) ReceptionCardTwoActivity.this.findViewById(R.id.editText04)).getText().toString(), ((EditText) ReceptionCardTwoActivity.this.findViewById(R.id.editText05)).getText().toString(), ((EditText) ReceptionCardTwoActivity.this.findViewById(R.id.editText06)).getText().toString(), ((EditText) ReceptionCardTwoActivity.this.findViewById(R.id.editText07)).getText().toString(), ((EditText) ReceptionCardTwoActivity.this.findViewById(R.id.editText08)).getText().toString(), ((EditText) ReceptionCardTwoActivity.this.findViewById(R.id.editText09)).getText().toString(), ((EditText) ReceptionCardTwoActivity.this.findViewById(R.id.editText10)).getText().toString(), ((EditText) ReceptionCardTwoActivity.this.findViewById(R.id.editText11)).getText().toString(), ((EditText) ReceptionCardTwoActivity.this.findViewById(R.id.editText12)).getText().toString(), ((EditText) ReceptionCardTwoActivity.this.findViewById(R.id.editText13)).getText().toString());
            }
        });
    }
