...
public class NikahCardTwoActivity extends AppCompatActivity {
    /* Access modifiers changed, original: protected */
    public void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        setContentView((int) R.layout.nikah_card_two_popup);
        Button button = (Button) findViewById(R.id.okButton);
        ((Button) findViewById(R.id.cancelButton)).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                NikahCardTwoActivity.this.finish();
            }
        });
        button.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                String str = "card_three";
                NikahCardTwoActivity.this.createPdf(str, ((EditText) NikahCardTwoActivity.this.findViewById(R.id.editText01)).getText().toString(), ((EditText) NikahCardTwoActivity.this.findViewById(R.id.editText02)).getText().toString(), ((EditText) NikahCardTwoActivity.this.findViewById(R.id.editText03)).getText().toString(), ((EditText) NikahCardTwoActivity.this.findViewById(R.id.editText04)).getText().toString(), ((EditText) NikahCardTwoActivity.this.findViewById(R.id.editText05)).getText().toString(), ((EditText) NikahCardTwoActivity.this.findViewById(R.id.editText06)).getText().toString(), ((EditText) NikahCardTwoActivity.this.findViewById(R.id.editText07)).getText().toString(), ((EditText) NikahCardTwoActivity.this.findViewById(R.id.editText08)).getText().toString(), ((EditText) NikahCardTwoActivity.this.findViewById(R.id.editText09)).getText().toString(), ((EditText) NikahCardTwoActivity.this.findViewById(R.id.editText10)).getText().toString(), ((EditText) NikahCardTwoActivity.this.findViewById(R.id.editText11)).getText().toString());
            }
        });
    }
