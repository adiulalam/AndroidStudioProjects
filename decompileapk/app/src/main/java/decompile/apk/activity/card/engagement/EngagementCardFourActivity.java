...
public class EngagementCardFourActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((Button) findViewById(R.id.cancelButton)).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                EngagementCardFourActivity.this.finish();
            }
        });
        button.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                String str = "engagement_card_four";
                EngagementCardFourActivity.this.createPdf(str, ((EditText) EngagementCardFourActivity.this.findViewById(R.id.editText01)).getText().toString(), ((EditText) EngagementCardFourActivity.this.findViewById(R.id.editText02)).getText().toString(), ((EditText) EngagementCardFourActivity.this.findViewById(R.id.editText03)).getText().toString(), ((EditText) EngagementCardFourActivity.this.findViewById(R.id.editText04)).getText().toString(), ((EditText) EngagementCardFourActivity.this.findViewById(R.id.editText05)).getText().toString(), ((EditText) EngagementCardFourActivity.this.findViewById(R.id.editText06)).getText().toString(), ((EditText) EngagementCardFourActivity.this.findViewById(R.id.editText07)).getText().toString(), ((EditText) EngagementCardFourActivity.this.findViewById(R.id.editText08)).getText().toString(), ((EditText) EngagementCardFourActivity.this.findViewById(R.id.editText09)).getText().toString(), ((EditText) EngagementCardFourActivity.this.findViewById(R.id.editText10)).getText().toString(), ((EditText) EngagementCardFourActivity.this.findViewById(R.id.editText11)).getText().toString(), ((EditText) EngagementCardFourActivity.this.findViewById(R.id.editText12)).getText().toString(), ((EditText) EngagementCardFourActivity.this.findViewById(R.id.editText13)).getText().toString());
            }
        });
    }
