...
public class ReceptionCardSixActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((Button) findViewById(R.id.cancelButton)).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ReceptionCardSixActivity.this.finish();
            }
        });
        button.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                String str = "reception_card_six";
                ReceptionCardSixActivity.this.createPdf(str, ((EditText) ReceptionCardSixActivity.this.findViewById(R.id.editText01)).getText().toString(), ((EditText) ReceptionCardSixActivity.this.findViewById(R.id.editText02)).getText().toString(), ((EditText) ReceptionCardSixActivity.this.findViewById(R.id.editText03)).getText().toString(), ((EditText) ReceptionCardSixActivity.this.findViewById(R.id.editText04)).getText().toString(), ((EditText) ReceptionCardSixActivity.this.findViewById(R.id.editText05)).getText().toString(), ((EditText) ReceptionCardSixActivity.this.findViewById(R.id.editText06)).getText().toString(), ((EditText) ReceptionCardSixActivity.this.findViewById(R.id.editText07)).getText().toString(), ((EditText) ReceptionCardSixActivity.this.findViewById(R.id.editText08)).getText().toString(), ((EditText) ReceptionCardSixActivity.this.findViewById(R.id.editText09)).getText().toString(), ((EditText) ReceptionCardSixActivity.this.findViewById(R.id.editText10)).getText().toString(), ((EditText) ReceptionCardSixActivity.this.findViewById(R.id.editText11)).getText().toString(), ((EditText) ReceptionCardSixActivity.this.findViewById(R.id.editText12)).getText().toString(), ((EditText) ReceptionCardSixActivity.this.findViewById(R.id.editText13)).getText().toString());
            }
        });
    }

    /* JADX WARNING: Failed to process nested try/catch */
    /* JADX WARNING: Missing block: B:33:0x03bb, code skipped:
            r0 = th;
     */
    /* JADX WARNING: Missing block: B:40:0x03d9, code skipped:
            r0 = move-exception;
     */
    /* JADX WARNING: Missing block: B:41:0x03da, code skipped:
            r3 = r6;
            r2 = r0;
     */
    ...
    private void createPdf(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14) {
        ...
        String str18 = "\n\n\n";
        String str19 = ".pdf";
        String str20 = "PDFCreator";
        String str21 = "\n\n";
        String str22 = XmpWriter.UTF8;
        String str23 = "";
        String str24 = "\n";
        ...
        try {
            ...
            if (str16.equals(str23)) {
                ...
                try {
                    ...
                    try {
                        ...
                        baseColor2 = new BaseColor(0, 0, 0);
                        BaseColor baseColor3 = new BaseColor(0, 0, 0);
                        BaseFont createFont = BaseFont.createFont("assets/fonts/bentham.otf", str22, true);
                        str25 = str19;
                        BaseFont createFont2 = BaseFont.createFont("assets/fonts/amelia_giovani.otf", str22, true);
                        str26 = format;
                        BaseFont createFont3 = BaseFont.createFont("assets/fonts/agency_fb.ttf", str22, true);
                        file = externalFilesDir;
                        Font font = new Font(createFont, 15.0f, 0, baseColor);
                        String str27 = str21;
                        Font font2 = new Font(createFont2, 40.0f, 1, baseColor3);
                        ...
                        paragraph3.add(stringBuilder5.toString());
                        paragraph.setAlignment(1);
            ...
            stringBuilder7.append(str25);
            String stringBuilder8 = stringBuilder7.toString();
            PrintStream printStream = System.out;
            stringBuilder2 = new StringBuilder();
            stringBuilder2.append("PDF View Path: ");
            stringBuilder2.append(stringBuilder8);
            printStream.println(stringBuilder2.toString());
            Intent intent = new Intent(getApplicationContext(), ViewPdf.class);
            intent.putExtra("pdf_path", stringBuilder8);
            intent.putExtra("full_name", str17);
            intent.putExtra(NotificationCompat.CATEGORY_EMAIL, str23);
            intent.putExtra("mobile", str23);
