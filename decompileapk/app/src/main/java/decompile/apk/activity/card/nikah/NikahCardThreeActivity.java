...
public class NikahCardThreeActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((Button) findViewById(R.id.cancelButton)).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                NikahCardThreeActivity.this.finish();
            }
        });
        button.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                String str = "card_four";
                NikahCardThreeActivity.this.createPdf(str, ((EditText) NikahCardThreeActivity.this.findViewById(R.id.editText01)).getText().toString(), ((EditText) NikahCardThreeActivity.this.findViewById(R.id.editText02)).getText().toString(), ((EditText) NikahCardThreeActivity.this.findViewById(R.id.editText03)).getText().toString(), ((EditText) NikahCardThreeActivity.this.findViewById(R.id.editText04)).getText().toString(), ((EditText) NikahCardThreeActivity.this.findViewById(R.id.editText05)).getText().toString(), ((EditText) NikahCardThreeActivity.this.findViewById(R.id.editText06)).getText().toString(), ((EditText) NikahCardThreeActivity.this.findViewById(R.id.editText07)).getText().toString(), ((EditText) NikahCardThreeActivity.this.findViewById(R.id.editText08)).getText().toString(), ((EditText) NikahCardThreeActivity.this.findViewById(R.id.editText09)).getText().toString(), ((EditText) NikahCardThreeActivity.this.findViewById(R.id.editText10)).getText().toString(), ((EditText) NikahCardThreeActivity.this.findViewById(R.id.editText11)).getText().toString());
            }
        });
    }
