...
public class NikahCardSixActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((Button) findViewById(R.id.cancelButton)).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                NikahCardSixActivity.this.finish();
            }
        });
        button.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                String str = "card_ten";
                NikahCardSixActivity.this.createPdf(str, ((EditText) NikahCardSixActivity.this.findViewById(R.id.editText01)).getText().toString(), ((EditText) NikahCardSixActivity.this.findViewById(R.id.editText02)).getText().toString(), ((EditText) NikahCardSixActivity.this.findViewById(R.id.editText03)).getText().toString(), ((EditText) NikahCardSixActivity.this.findViewById(R.id.editText04)).getText().toString(), ((EditText) NikahCardSixActivity.this.findViewById(R.id.editText05)).getText().toString(), ((EditText) NikahCardSixActivity.this.findViewById(R.id.editText06)).getText().toString(), ((EditText) NikahCardSixActivity.this.findViewById(R.id.editText07)).getText().toString(), ((EditText) NikahCardSixActivity.this.findViewById(R.id.editText08)).getText().toString(), ((EditText) NikahCardSixActivity.this.findViewById(R.id.editText09)).getText().toString(), ((EditText) NikahCardSixActivity.this.findViewById(R.id.editText10)).getText().toString(), ((EditText) NikahCardSixActivity.this.findViewById(R.id.editText11)).getText().toString());
            }
        });
    }

    /* JADX WARNING: Failed to process nested try/catch */
    /* JADX WARNING: Missing block: B:34:0x039f, code skipped:
            r0 = th;
     */
    /* JADX WARNING: Missing block: B:41:0x03bd, code skipped:
            r0 = move-exception;
     */
    /* JADX WARNING: Missing block: B:42:0x03be, code skipped:
            r3 = r5;
            r2 = r0;
     */
        ...
        try {
            ...
            if (str14.equals(str20)) {
                ...
                try {
                    ...
                    BaseColor baseColor2 = new BaseColor((int) Callback.DEFAULT_SWIPE_ANIMATION_DURATION, 255, 255);
