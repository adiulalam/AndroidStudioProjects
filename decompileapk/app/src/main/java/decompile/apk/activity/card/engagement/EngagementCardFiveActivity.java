package decompile.apk.activity.card.engagement;
...
public class EngagementCardFiveActivity extends AppCompatActivity {
    /* Access modifiers changed, original: protected */
    public void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        setContentView((int) R.layout.engagement_card_one_popup);
        Button button = (Button) findViewById(R.id.okButton);
        ((Button) findViewById(R.id.cancelButton)).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                EngagementCardFiveActivity.this.finish();
            }
        });
        button.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                String str = "engagement_card_five";
                EngagementCardFiveActivity.this.createPdf(str, ((EditText) EngagementCardFiveActivity.this.findViewById(R.id.editText01)).getText().toString(), ((EditText) EngagementCardFiveActivity.this.findViewById(R.id.editText02)).getText().toString(), ((EditText) EngagementCardFiveActivity.this.findViewById(R.id.editText03)).getText().toString(), ((EditText) EngagementCardFiveActivity.this.findViewById(R.id.editText04)).getText().toString(), ((EditText) EngagementCardFiveActivity.this.findViewById(R.id.editText05)).getText().toString(), ((EditText) EngagementCardFiveActivity.this.findViewById(R.id.editText06)).getText().toString(), ((EditText) EngagementCardFiveActivity.this.findViewById(R.id.editText07)).getText().toString(), ((EditText) EngagementCardFiveActivity.this.findViewById(R.id.editText08)).getText().toString(), ((EditText) EngagementCardFiveActivity.this.findViewById(R.id.editText09)).getText().toString(), ((EditText) EngagementCardFiveActivity.this.findViewById(R.id.editText10)).getText().toString(), ((EditText) EngagementCardFiveActivity.this.findViewById(R.id.editText11)).getText().toString(), ((EditText) EngagementCardFiveActivity.this.findViewById(R.id.editText12)).getText().toString(), ((EditText) EngagementCardFiveActivity.this.findViewById(R.id.editText13)).getText().toString());
            }
        });
    }

    /* JADX WARNING: Failed to process nested try/catch */
    /* JADX WARNING: Missing block: B:34:0x03cb, code skipped:
            r0 = th;
     */
    /* JADX WARNING: Missing block: B:41:0x03e9, code skipped:
            r0 = move-exception;
     */
    /* JADX WARNING: Missing block: B:42:0x03ea, code skipped:
            r3 = r5;
            r2 = r0;
     */
        ...
        try {
            ...
            if (str16.equals(str22)) {
                ...
                try {
                    ...
                    BaseColor baseColor = new BaseColor((int) CipherSuite.TLS_RSA_PSK_WITH_AES_256_CBC_SHA, 104, 53);
                    BaseColor baseColor2 = new BaseColor((int) CipherSuite.TLS_DH_RSA_WITH_CAMELLIA_256_CBC_SHA, 111, 91);
                    baseColor2 = new BaseColor(214, (int) CipherSuite.TLS_DH_RSA_WITH_SEED_CBC_SHA, (int) CipherSuite.TLS_DH_DSS_WITH_CAMELLIA_256_CBC_SHA);
                    try {
                        BaseColor baseColor3 = new BaseColor(223, (int) CipherSuite.TLS_PSK_WITH_AES_128_GCM_SHA256, 39);
                        ...
                        Font font4 = new Font(createFont, 19.0f, 0, baseColor2);
                        Font font5 = new Font(createFont, 19.0f, 0, baseColor);
                        font5 = new Font(createFont, 15.0f, 0, baseColor);
