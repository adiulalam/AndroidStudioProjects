...
public class WeddingCardNineActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((Button) findViewById(R.id.cancelButton)).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                WeddingCardNineActivity.this.finish();
            }
        });
        button.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                String str = "card_nine";
                WeddingCardNineActivity.this.createPdf(str, ((EditText) WeddingCardNineActivity.this.findViewById(R.id.editText01)).getText().toString(), ((EditText) WeddingCardNineActivity.this.findViewById(R.id.editText02)).getText().toString(), ((EditText) WeddingCardNineActivity.this.findViewById(R.id.editText03)).getText().toString(), ((EditText) WeddingCardNineActivity.this.findViewById(R.id.editText04)).getText().toString(), ((EditText) WeddingCardNineActivity.this.findViewById(R.id.editText05)).getText().toString(), ((EditText) WeddingCardNineActivity.this.findViewById(R.id.editText06)).getText().toString(), ((EditText) WeddingCardNineActivity.this.findViewById(R.id.editText07)).getText().toString(), ((EditText) WeddingCardNineActivity.this.findViewById(R.id.editText08)).getText().toString(), ((EditText) WeddingCardNineActivity.this.findViewById(R.id.editText09)).getText().toString(), ((EditText) WeddingCardNineActivity.this.findViewById(R.id.editText10)).getText().toString(), ((EditText) WeddingCardNineActivity.this.findViewById(R.id.editText11)).getText().toString());
            }
        });
    }

    /* JADX WARNING: Failed to process nested try/catch */
    /* JADX WARNING: Missing block: B:34:0x03a2, code skipped:
            r0 = th;
     */
    /* JADX WARNING: Missing block: B:41:0x03c0, code skipped:
            r0 = move-exception;
     */
    /* JADX WARNING: Missing block: B:42:0x03c1, code skipped:
            r3 = r5;
            r2 = r0;
     */
        ...
        try {
            ...
            if (str14.equals(str20)) {
                ...
                try {
                    ...
                    BaseColor baseColor = new BaseColor((int) CipherSuite.TLS_DH_DSS_WITH_CAMELLIA_128_CBC_SHA256, (int) CipherSuite.TLS_PSK_WITH_AES_128_GCM_SHA256, 102);
                    BaseColor baseColor2 = new BaseColor((int) CipherSuite.TLS_DH_DSS_WITH_CAMELLIA_128_CBC_SHA256, (int) CipherSuite.TLS_PSK_WITH_AES_128_GCM_SHA256, 102);
                    ...
                    try {
                        ...
                        phrase.add(stringBuilder5.toString());
                        paragraph.setAlignment(1);
