...
public class ReceptionCardFiveActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((Button) findViewById(R.id.cancelButton)).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ReceptionCardFiveActivity.this.finish();
            }
        });
        button.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                String str = "reception_card_five";
                ReceptionCardFiveActivity.this.createPdf(str, ((EditText) ReceptionCardFiveActivity.this.findViewById(R.id.editText01)).getText().toString(), ((EditText) ReceptionCardFiveActivity.this.findViewById(R.id.editText02)).getText().toString(), ((EditText) ReceptionCardFiveActivity.this.findViewById(R.id.editText03)).getText().toString(), ((EditText) ReceptionCardFiveActivity.this.findViewById(R.id.editText04)).getText().toString(), ((EditText) ReceptionCardFiveActivity.this.findViewById(R.id.editText05)).getText().toString(), ((EditText) ReceptionCardFiveActivity.this.findViewById(R.id.editText06)).getText().toString(), ((EditText) ReceptionCardFiveActivity.this.findViewById(R.id.editText07)).getText().toString(), ((EditText) ReceptionCardFiveActivity.this.findViewById(R.id.editText08)).getText().toString(), ((EditText) ReceptionCardFiveActivity.this.findViewById(R.id.editText09)).getText().toString(), ((EditText) ReceptionCardFiveActivity.this.findViewById(R.id.editText10)).getText().toString(), ((EditText) ReceptionCardFiveActivity.this.findViewById(R.id.editText11)).getText().toString(), ((EditText) ReceptionCardFiveActivity.this.findViewById(R.id.editText12)).getText().toString(), ((EditText) ReceptionCardFiveActivity.this.findViewById(R.id.editText13)).getText().toString());
            }
        });
    }

    /* JADX WARNING: Failed to process nested try/catch */
    /* JADX WARNING: Missing block: B:33:0x03bf, code skipped:
            r0 = th;
     */
    /* JADX WARNING: Missing block: B:40:0x03dd, code skipped:
            r0 = move-exception;
     */
    /* JADX WARNING: Missing block: B:41:0x03de, code skipped:
            r3 = r6;
            r2 = r0;
     */
            ...
            if (str16.equals(str23)) {
                ...
                try {
                    ...
                    try {
                        ...
                        BaseColor baseColor = new BaseColor(122, 120, 99);
                        BaseColor baseColor2 = new BaseColor(122, 120, 99);
                        baseColor2 = new BaseColor(122, 120, 99);
                        str25 = str19;
                        BaseColor baseColor3 = new BaseColor(122, 120, 99);
