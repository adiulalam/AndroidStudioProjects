...
public class ReferenceDetailsActivity extends AppCompatActivity {
    ...
    public EditText input_reference_address;
    public String input_reference_address1;
    public EditText input_reference_contact_no;
    public String input_reference_contact_no1;
    public EditText input_reference_name;
    ...
    public ReferenceDetailsActivity() {
        String str = "";
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_reference_details);
        this.input_reference_name = (EditText) findViewById(R.id.input_reference_name);
        this.black = (CheckBox) findViewById(R.id.black);
        this.brown_red = (CheckBox) findViewById(R.id.brown_red);
        if (Constant.biodata_title_color.equals("Black")) {
            this.black.setChecked(true);
            this.brown_red.setChecked(false);
        } else {
            this.black.setChecked(false);
            this.brown_red.setChecked(true);
        }
        ...
        this.input_reference_name.setText(Constant.biodata_title);
        Button button = (Button) findViewById(R.id.back);
        this.back = button;
        button.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ReferenceDetailsActivity.this.backData();
                ReferenceDetailsActivity.this.finish();
            }
        });
        ...
        button.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ReferenceDetailsActivity.this.addressDetails();
            }
        });
    ...
    public void addressDetails() {
        Constant.biodata_title = this.input_reference_name.getText().toString();
        if (this.black.isChecked() && this.brown_red.isChecked()) {
            Toast.makeText(this, "Choose any one color", 0).show();
            return;
        }
        if (this.black.isChecked()) {
            Constant.biodata_title_color = "Black";
            this.brown_red.setChecked(false);
        } else {
            Constant.biodata_title_color = "Brown Red";
            this.black.setChecked(false);
        }
    ...
    public void backData() {
        ...
        intent.putExtra("state", this.state);
        intent.putExtra("pincode", this.pincode);
        intent.putExtra("reference_name", this.input_reference_name1);
        intent.putExtra("reference_contact_no", this.input_reference_contact_no1);
        intent.putExtra("reference_address", this.input_reference_address1);
        startActivity(intent);
    }
