...
public class WeddingCardThreeActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((Button) findViewById(R.id.cancelButton)).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                WeddingCardThreeActivity.this.finish();
            }
        });
        button.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                String str = "card_three";
                WeddingCardThreeActivity.this.createPdf(str, ((EditText) WeddingCardThreeActivity.this.findViewById(R.id.editText01)).getText().toString(), ((EditText) WeddingCardThreeActivity.this.findViewById(R.id.editText02)).getText().toString(), ((EditText) WeddingCardThreeActivity.this.findViewById(R.id.editText03)).getText().toString(), ((EditText) WeddingCardThreeActivity.this.findViewById(R.id.editText04)).getText().toString(), ((EditText) WeddingCardThreeActivity.this.findViewById(R.id.editText05)).getText().toString(), ((EditText) WeddingCardThreeActivity.this.findViewById(R.id.editText06)).getText().toString(), ((EditText) WeddingCardThreeActivity.this.findViewById(R.id.editText07)).getText().toString(), ((EditText) WeddingCardThreeActivity.this.findViewById(R.id.editText08)).getText().toString(), ((EditText) WeddingCardThreeActivity.this.findViewById(R.id.editText09)).getText().toString(), ((EditText) WeddingCardThreeActivity.this.findViewById(R.id.editText10)).getText().toString(), ((EditText) WeddingCardThreeActivity.this.findViewById(R.id.editText11)).getText().toString());
            }
        });
    }

    /* JADX WARNING: Failed to process nested try/catch */
    /* JADX WARNING: Missing block: B:34:0x035f, code skipped:
            r0 = th;
     */
    /* JADX WARNING: Missing block: B:41:0x037d, code skipped:
            r0 = move-exception;
     */
    /* JADX WARNING: Missing block: B:42:0x037e, code skipped:
            r3 = r6;
            r2 = r0;
     */
        ...
        try {
            ...
            if (str14.equals(str20)) {
                ...
                try {
                    ...
                    BaseColor baseColor = new BaseColor((int) CipherSuite.TLS_DH_RSA_WITH_CAMELLIA_256_CBC_SHA, 111, 91);
                    BaseColor baseColor2 = new BaseColor((int) CipherSuite.TLS_DH_RSA_WITH_CAMELLIA_256_CBC_SHA, 111, 91);
                    BaseFont createFont = BaseFont.createFont("assets/fonts/bentham.otf", str19, true);
                    BaseFont createFont2 = BaseFont.createFont("assets/fonts/amelia_giovani.otf", str19, true);
                    try {
                        ...
                        str23 = format;
                        Font font2 = new Font(createFont2, 50.0f, 1, baseColor2);
