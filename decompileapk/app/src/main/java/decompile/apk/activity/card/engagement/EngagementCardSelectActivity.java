...
import Adapter.EngagementCardCategoryRecycleAdapter;
...
public class EngagementCardSelectActivity extends AppCompatActivity {
    ...
    private EngagementCardCategoryRecycleAdapter engagementCardCategoryRecycleAdapter;
    ...
    private Integer[] image = new Integer[]{Integer.valueOf(R.drawable.engagement_card_one_preview), Integer.valueOf(R.drawable.engagement_card_two_preview), Integer.valueOf(R.drawable.engagement_card_three_preview), Integer.valueOf(R.drawable.engagement_card_four_preview), Integer.valueOf(R.drawable.engagement_card_five_preview), Integer.valueOf(R.drawable.engagement_card_six_preview)};
    ...
    public EngagementCardSelectActivity() {
        String str = "";
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_engagement_card_select);
        requestPermission();
        ...
        while (true) {
            ...
            if (i < numArr.length) {
                ...
                EngagementCardCategoryRecycleAdapter engagementCardCategoryRecycleAdapter = new EngagementCardCategoryRecycleAdapter(getApplicationContext(), this.cardCategoryModelClass);
                this.engagementCardCategoryRecycleAdapter = engagementCardCategoryRecycleAdapter;
                this.recyclerView.setAdapter(engagementCardCategoryRecycleAdapter);
                return;
            }
        }
    }
